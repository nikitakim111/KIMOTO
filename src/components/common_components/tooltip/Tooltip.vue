<template>
    <div class="tooltip" :tooltip-position="tooltip_position" :tooltip-text="tooltip_text" role="tooltip">
        <div class="tooltip__wrapper">
            <svg class="tooltip__icon" width="16" height="16" viewBox="0 0 16 16" fill="none"
